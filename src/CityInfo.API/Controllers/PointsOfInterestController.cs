...
namespace CityInfo.API.Controllers
{
    ...
    public class PointsOfInterestController : Controller
    {
        ...
        public IActionResult UpdatePointOfInterest(int cityId, int id, [FromBody] PointOfInterestForUpdateDto pointOfInterest)
        {
            ...
            var pointOfInterstEntity = _cityInfoRepository.GetPointOfInterest(cityId, id);
        ...
        public IActionResult DeletePointOfInterest(int cityId, int id)
        {
            ...
            _mailService.Send("Point of interest deleted.", "Point of interest " + pointOfInterstEntity.Name + " with id " + pointOfInterstEntity.Id + "was deleted.");
